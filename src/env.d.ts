...
interface ImportMetaEnv {
  ...
  /** Clerk publishable key — public, browser-side, cross-subdomain SSO for *.oriz.in. */
  readonly PUBLIC_CLERK_PUBLISHABLE_KEY?: string
  /** Firebase (Firestore only — Clerk owns auth). Public browser config, env not hardcoded. */
